...
urlpatterns = [
    ...
    # keep ONLY this get_messages (lane-aware)
    ...
    path('contexts/<uuid:conversation_id>/', views.lanes, name='lanes'),
    path('contexts/<uuid:conversation_id>/<uuid:lane_id>/', views.lane_detail, name='lane_detail'),

    path('conversations/<uuid:conversation_id>/mode/', views.set_conversation_mode, name='set_conversation_mode'),

    # NEW: prefs (theme/bg)
    path('conversations/<uuid:conversation_id>/prefs/', views.conversation_prefs, name='conversation_prefs'),
]