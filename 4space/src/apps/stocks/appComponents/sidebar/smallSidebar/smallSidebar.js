...
const StocksSmallSidebar = ({ }) => {
    ...
    return (
        <div className='stocks-small-sidebar'>
            <div className='stocks-small-sidebar-inner'>
                {taskFlow.map((item, index) => (
                    <div
                        key={index}
                        className="stocks-small-sidebar-item"
...
export default StocksSmallSidebar;